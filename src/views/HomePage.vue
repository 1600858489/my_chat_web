            ...
            <div class="sidebar-container" style="width: 360px;">
                <div class="module-list">
                    ...
                    <div class="menu-bottom">
                        ...
                        <div title="切换为夜间模式" class="module-item">
                            <svg id="my-svg" width="70" height="39.99999999999999" xmlns="http://www.w3.org/2000/svg" stroke="#666666">
                                 <g >
                                  <title>Layer 1</title>
                    ...
                    <div class="avatar">
                        <!---->
                        <img src="logo1.png" width="45px" height="45px">
                    </div>
                </div>
                <div id="sub-module" class="sub-module">
                    <div class="module-chat" v-if="currentPageIndex === 0">
                        ...
                        <div class="module-write" v-if="currentPageIndex === 1">
                            <div class="module-header">
                                <div class="search">
...
<!--                            </div>-->
                            <button type="button" class="el-button btn-send el-button--default" style=""  :disabled="sendButtonDisabled" @click="sendUserInput"  >
                                <svg id="my-svg" width="25" height="25" xmlns="http://www.w3.org/2000/svg" stroke="null">
                                     <g stroke="null">
                                      <title stroke="null">Layer 1</title>
