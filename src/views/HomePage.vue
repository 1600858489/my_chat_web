<template >
  <div id="app">
        <div class="app-wrapper theme-light">
            <div class="sidebar-container" style="width: 360px;">
                <div class="module-list">
                    <div class="module-item" >
<!--                        <div :style="{ fill: svgColors.svgElement1, stroke: svgColors.svgElement1 }" v-on:click="showPage(0)" class="clickable-svg" ref="svgElement1" @click="handleSVGClick($event, 'svgElement1')" >-->
...
<!--                          <SvgIcon iconId="icon1" className="my-icon"></SvgIcon>-->
                          <span>对话</span>
...
<!--                        </div>-->
                    ...
                    <div class="menu-bottom">
                        ...
                        <div title="切换主题" class="module-item" id="theme-overlay">
                          <svg v-if="isDarkTheme" @click="toggleTheme" width="70" height="70" id="my_svg" xmlns="http://www.w3.org/2000/svg">
                                <g id="day-icon" ref="dayIcon" class="icon-black">
                                  <title>Day Icon</title>
                                  <path  id="svg_2" d="m5.54694,16.54636l3.93983,1.20011l0,-2.39894l-3.93983,1.19883zm2.86065,-5.91173l1.7949,3.23481l1.98074,-1.69728l-3.77564,-1.53752zm6.90348,-2.44815l-1.40085,3.37412l2.80244,0l-1.40159,-3.37412zm6.90423,2.44815l-3.77714,1.53752l1.98149,1.69728l1.79565,-3.23481zm2.85991,5.91173l-3.94058,-1.19883l0,2.39894l3.94058,-1.20011zm-2.85991,5.91173l-1.79565,-3.23353l-1.98149,1.69664l3.77714,1.53688l0,0zm-6.90423,2.45007l1.40159,-3.37475l-2.80244,0l1.40085,3.37475zm-6.90348,-2.45007l3.77639,-1.53624l-1.98074,-1.69664l-1.79565,3.23289zm11.78517,-5.91173l0,0c0,-2.3082 -2.18598,-4.17994 -4.88244,-4.17994c-2.69572,0 -4.88244,1.87174 -4.88244,4.17994c0,2.30884 2.18672,4.18058 4.88244,4.18058c2.69721,0 4.88244,-1.87174 4.88244,-4.18058l0,0z" />
                                 </g>

                              </svg>
                              <!-- 黑夜图标 -->
                              <svg v-else @click="toggleTheme" width="70" height="70" xmlns="http://www.w3.org/2000/svg">
                                <g id="night-icon" ref="nightIcon"  class="icon-white">
                                  <title>Night Icon</title>
                                  <path id="svg_20" d="m374,218c-1,-1 -4.05334,-4.96837 -7,-10c-4.07422,-6.95706 -6.83179,-11.52216 -10,-18c-1.38934,-2.84073 -3.98691,-5.75711 -5,-12c-0.48056,-2.96126 -2.14774,-5.94341 -4,-11c-1.08768,-2.96933 -2.44519,-8.03867 -3,-12c-1.00977,-7.20975 -2,-12 -2,-20c0,-8 0,-14 0,-19c0,-6 0,-11 0,-14c0,-4 -0.63834,-8.3054 2,-13c2.44962,-4.35883 8,-12 13,-17c6,-6 11.70425,-11.40069 17,-15c6.66794,-4.53193 13,-7 19,-10c6,-3 13.02756,-5.91912 19,-8c11.05304,-3.85103 17.45871,-4.66397 25,-8c3.29733,-1.45864 8.82376,-2.48626 11,-3c1.9465,-0.45951 3.0535,-0.45951 5,0c2.17624,0.51374 3.11215,1.9183 6,6c2.08246,2.94336 5.3851,7.37201 8,11c3.30762,4.58908 7.724,7.22273 11,11c4.63297,5.34187 9,9 12,13c3,4 4.71933,6.56511 7,10c2.76575,4.16542 5.41589,4.76108 7,8c1.38934,2.84072 2.33749,4.31001 4,7c1.487,2.40601 3.9176,2.38687 5,5c0.38269,0.92388 -0.05145,2.2987 1,4c1.1756,1.90211 2,2 2,4c0,1 1,2 1,4c0,1 0,2 0,3c0,2 0,3 0,4c0,2 1,2 1,3c0,1 0,2 0,3c0,2 -0.38269,3.07612 0,4c0.5412,1.30656 1,3 1,4c0,1 0,3 0,4c0,1 -1.41418,2.58578 0,4c0.70709,0.70711 1,1 1,2c0,1 0,4 0,6c0,1 0,4 0,5c0,2 -1,2 -1,3c0,1 -1.31073,4.08025 -2,7c-0.51373,2.17625 -2.29291,3.29289 -3,4c-1.41418,1.41422 -1,4 -2,6c-1,2 -2.61731,3.07613 -3,4c-1.0824,2.61313 -3.71411,3.21167 -6,6c-0.89661,1.09367 -3,3 -4,4c-1,1 -2.86829,2.28859 -7,4c-5.84314,2.4203 -6.54916,3.95517 -10,5c-0.95709,0.28978 -7,1 -10,3c-3,2 -4.87857,2.49345 -8,3c-0.98709,0.16019 -2.08582,-0.57957 -4,0c-3.45084,1.04483 -4.03873,1.51945 -7,2c-3.12143,0.50655 -7.83807,2.46552 -13,4c-4.88763,1.45294 -9.75711,3.98692 -16,5c-2.96127,0.48055 -5.54916,0.95517 -9,2c-0.95709,0.28978 -2,0 -3,0c-5,0 -9.17163,-0.15913 -13,1c-6.9017,2.08966 -12,4 -14,5l-2,1l-3,1l-3,0" />
                                  <path id="svg_8" d="m20.07317,24.52439" opacity="NaN" />
                                  <path id="svg_9" d="m44.98364,34.30675l0,0c-11.61269,0 -21.0285,-6.78454 -21.0285,-15.15635c0,-8.37074 9.41581,-15.15635 21.0285,-15.15635l0,0c-6.61808,3.57781 -10.51353,9.19334 -10.51353,15.15635s3.89545,11.57747 10.51353,15.15635z" fill="#ffffff"/>

                                </g>
                              </svg>

<!--                          <svg v-if="isDarkTheme" @click="toggleTheme" width="30" height="30" xmlns="http://www.w3.org/2000/svg">-->
<!--                               <g id="Layer_1">-->
<!--                                  <title>Layer 1</title>-->
<!--                                  <path stroke="null" id="svg_2" d="m5.54694,16.54636l3.93983,1.20011l0,-2.39894l-3.93983,1.19883zm2.86065,-5.91173l1.7949,3.23481l1.98074,-1.69728l-3.77564,-1.53752zm6.90348,-2.44815l-1.40085,3.37412l2.80244,0l-1.40159,-3.37412zm6.90423,2.44815l-3.77714,1.53752l1.98149,1.69728l1.79565,-3.23481zm2.85991,5.91173l-3.94058,-1.19883l0,2.39894l3.94058,-1.20011zm-2.85991,5.91173l-1.79565,-3.23353l-1.98149,1.69664l3.77714,1.53688l0,0zm-6.90423,2.45007l1.40159,-3.37475l-2.80244,0l1.40085,3.37475zm-6.90348,-2.45007l3.77639,-1.53624l-1.98074,-1.69664l-1.79565,3.23289zm11.78517,-5.91173l0,0c0,-2.3082 -2.18598,-4.17994 -4.88244,-4.17994c-2.69572,0 -4.88244,1.87174 -4.88244,4.17994c0,2.30884 2.18672,4.18058 4.88244,4.18058c2.69721,0 4.88244,-1.87174 4.88244,-4.18058l0,0z" fill="black"/>-->
<!--                                 </g>-->
<!--                            </svg>-->
<!--                            <svg v-else @click="toggleTheme" width="100" height="100" xmlns="http://www.w3.org/2000/svg">-->
<!--                              <g >-->
<!--                                  <title>Layer 1</title>-->
<!--                                  <path id="svg_20" d="m374,218c-1,-1 -4.05334,-4.96837 -7,-10c-4.07422,-6.95706 -6.83179,-11.52216 -10,-18c-1.38934,-2.84073 -3.98691,-5.75711 -5,-12c-0.48056,-2.96126 -2.14774,-5.94341 -4,-11c-1.08768,-2.96933 -2.44519,-8.03867 -3,-12c-1.00977,-7.20975 -2,-12 -2,-20c0,-8 0,-14 0,-19c0,-6 0,-11 0,-14c0,-4 -0.63834,-8.3054 2,-13c2.44962,-4.35883 8,-12 13,-17c6,-6 11.70425,-11.40069 17,-15c6.66794,-4.53193 13,-7 19,-10c6,-3 13.02756,-5.91912 19,-8c11.05304,-3.85103 17.45871,-4.66397 25,-8c3.29733,-1.45864 8.82376,-2.48626 11,-3c1.9465,-0.45951 3.0535,-0.45951 5,0c2.17624,0.51374 3.11215,1.9183 6,6c2.08246,2.94336 5.3851,7.37201 8,11c3.30762,4.58908 7.724,7.22273 11,11c4.63297,5.34187 9,9 12,13c3,4 4.71933,6.56511 7,10c2.76575,4.16542 5.41589,4.76108 7,8c1.38934,2.84072 2.33749,4.31001 4,7c1.487,2.40601 3.9176,2.38687 5,5c0.38269,0.92388 -0.05145,2.2987 1,4c1.1756,1.90211 2,2 2,4c0,1 1,2 1,4c0,1 0,2 0,3c0,2 0,3 0,4c0,2 1,2 1,3c0,1 0,2 0,3c0,2 -0.38269,3.07612 0,4c0.5412,1.30656 1,3 1,4c0,1 0,3 0,4c0,1 -1.41418,2.58578 0,4c0.70709,0.70711 1,1 1,2c0,1 0,4 0,6c0,1 0,4 0,5c0,2 -1,2 -1,3c0,1 -1.31073,4.08025 -2,7c-0.51373,2.17625 -2.29291,3.29289 -3,4c-1.41418,1.41422 -1,4 -2,6c-1,2 -2.61731,3.07613 -3,4c-1.0824,2.61313 -3.71411,3.21167 -6,6c-0.89661,1.09367 -3,3 -4,4c-1,1 -2.86829,2.28859 -7,4c-5.84314,2.4203 -6.54916,3.95517 -10,5c-0.95709,0.28978 -7,1 -10,3c-3,2 -4.87857,2.49345 -8,3c-0.98709,0.16019 -2.08582,-0.57957 -4,0c-3.45084,1.04483 -4.03873,1.51945 -7,2c-3.12143,0.50655 -7.83807,2.46552 -13,4c-4.88763,1.45294 -9.75711,3.98692 -16,5c-2.96127,0.48055 -5.54916,0.95517 -9,2c-0.95709,0.28978 -2,0 -3,0c-5,0 -9.17163,-0.15913 -13,1c-6.9017,2.08966 -12,4 -14,5l-2,1l-3,1l-3,0" />-->
<!--                                  <path id="svg_8" d="m20.07317,24.52439" opacity="NaN" />-->
...
<!--                            </svg>-->
<!--                            <svg :style="{ fill: svgColors.svgElement4, stroke: svgColors.svgElement4 }" class="clickable-svg" ref="svgElement4" @click="handleSVGClick($event, 'svgElement4')" id="my-svg" width="70" height="39.99999999999999" xmlns="http://www.w3.org/2000/svg" stroke="#666666">-->
<!--                                 <g >-->
<!--                                  <title>Layer 1</title>-->
<!--                                  <path id="svg_20" d="m374,218c-1,-1 -4.05334,-4.96837 -7,-10c-4.07422,-6.95706 -6.83179,-11.52216 -10,-18c-1.38934,-2.84073 -3.98691,-5.75711 -5,-12c-0.48056,-2.96126 -2.14774,-5.94341 -4,-11c-1.08768,-2.96933 -2.44519,-8.03867 -3,-12c-1.00977,-7.20975 -2,-12 -2,-20c0,-8 0,-14 0,-19c0,-6 0,-11 0,-14c0,-4 -0.63834,-8.3054 2,-13c2.44962,-4.35883 8,-12 13,-17c6,-6 11.70425,-11.40069 17,-15c6.66794,-4.53193 13,-7 19,-10c6,-3 13.02756,-5.91912 19,-8c11.05304,-3.85103 17.45871,-4.66397 25,-8c3.29733,-1.45864 8.82376,-2.48626 11,-3c1.9465,-0.45951 3.0535,-0.45951 5,0c2.17624,0.51374 3.11215,1.9183 6,6c2.08246,2.94336 5.3851,7.37201 8,11c3.30762,4.58908 7.724,7.22273 11,11c4.63297,5.34187 9,9 12,13c3,4 4.71933,6.56511 7,10c2.76575,4.16542 5.41589,4.76108 7,8c1.38934,2.84072 2.33749,4.31001 4,7c1.487,2.40601 3.9176,2.38687 5,5c0.38269,0.92388 -0.05145,2.2987 1,4c1.1756,1.90211 2,2 2,4c0,1 1,2 1,4c0,1 0,2 0,3c0,2 0,3 0,4c0,2 1,2 1,3c0,1 0,2 0,3c0,2 -0.38269,3.07612 0,4c0.5412,1.30656 1,3 1,4c0,1 0,3 0,4c0,1 -1.41418,2.58578 0,4c0.70709,0.70711 1,1 1,2c0,1 0,4 0,6c0,1 0,4 0,5c0,2 -1,2 -1,3c0,1 -1.31073,4.08025 -2,7c-0.51373,2.17625 -2.29291,3.29289 -3,4c-1.41418,1.41422 -1,4 -2,6c-1,2 -2.61731,3.07613 -3,4c-1.0824,2.61313 -3.71411,3.21167 -6,6c-0.89661,1.09367 -3,3 -4,4c-1,1 -2.86829,2.28859 -7,4c-5.84314,2.4203 -6.54916,3.95517 -10,5c-0.95709,0.28978 -7,1 -10,3c-3,2 -4.87857,2.49345 -8,3c-0.98709,0.16019 -2.08582,-0.57957 -4,0c-3.45084,1.04483 -4.03873,1.51945 -7,2c-3.12143,0.50655 -7.83807,2.46552 -13,4c-4.88763,1.45294 -9.75711,3.98692 -16,5c-2.96127,0.48055 -5.54916,0.95517 -9,2c-0.95709,0.28978 -2,0 -3,0c-5,0 -9.17163,-0.15913 -13,1c-6.9017,2.08966 -12,4 -14,5l-2,1l-3,1l-3,0" />-->
<!--                                  <path id="svg_8" d="m20.07317,24.52439" opacity="NaN" />-->
...
<!--                                </svg>-->
                    ...
                    <div class="avatar">
                        <!---->
                        <img :src="user.avatar" alt="User Avatar" width="60px">
                    </div>
                </div>
                <div id="sub-module" class="sub-module">
                    <div class="module-chat" v-if="showingPage === 0">
                                        ...
                                        <div class="group-chat">
                                            ...
                                            <ul>
                                              <li v-for="conversation in conversations" :key="conversation.conversation_id" @click="selectConversation(conversation.conversation_id)" :class="{ 'selected': conversation.conversation_id === selectedConversationId }">
                                                ...
                                                <button class="delet-conversation" v-if="conversation.conversation_id === selectedConversationId" @click="deleteConversation(conversation.conversation_id)">删除</button>
                                              </li>
                                            </ul>
                        ...
                        <div class="module-write" v-if="showingPage === 1">
                            <div class="module-header">
                                <div class="search">
                                    <div class="el-input el-input--large el-input--prefix el-input--suffix">
                                        <!---->
                                        <input type="text" autocomplete="" placeholder="搜索模型" class="el-input__inner">
...
<!--                                            </div>-->
                ...
                <div class="el-scrollbar__bar is-vertical">
                    <div class="el-scrollbar__thumb" style="transform: translateY(0%); height: 1.29344%;">
            ...
            <div class="main-container" style="margin-left: 360px;">
                <div class="wrapper">
                    <div class="tab-model">
                        <div class="tab-item active" style="border-top-right-radius: 0px; border-bottom-right-radius: 0px;">GPT-3.5</div>
                        <div class="tab-item" style="border-top-left-radius: 0px; border-bottom-left-radius: 0px;">GPT-4</div>
                    </div>
                    <div data-v-0d572f78="" class="welcome">
                        <div data-v-0d572f78="" class="title">Chat With Me Now</div>

                      <div v-if="messages.length === 0" class="default-message">
                          <div data-v-0d572f78="" class="tips-list">
                            <div data-v-0d572f78="" class="column">
                              <div data-v-0d572f78="" class="h-item">
                                <div class="svg-image">
                                ...
                                <div data-v-0d572f78="" class="tit">AI 创作</div>
                              </div>
                              <ul>
                                <li class="q-preinstall" data-v-0d572f78="" @click="getProblem('写一首赞美祖国的诗')">写一首赞美祖国的诗 →</li>
                                <li class="q-preinstall" data-v-0d572f78="" @click="getProblem('写一篇科幻小说')">写一篇科幻小说 →</li>
                                <li class="q-preinstall" data-v-0d572f78="" @click="getProblem('安排一场发布会流程')">写一篇实习报告 →</li>
                              </ul>
                            </div>
                            <div data-v-0d572f78="" class="column">
                              <div data-v-0d572f78="" class="h-item">
                                <div >
                                  <svg  id="my-svg" width="30" height="30" xmlns="http://www.w3.org/2000/svg">
                                   <g>
                                ...
                                <div data-v-0d572f78="" class="tit">有趣的提问</div>
                              </div>
                              <ul>
                                <li data-v-0d572f78="" class="q-preinstall" @click="getProblem('有哪些有趣的科学实验')">有哪些有趣的科学实验 →</li>
                                <li data-v-0d572f78="" class="q-preinstall" @click="getProblem('问一个AI答不出的问题')">问一个AI答不出的问题 →</li>
                                <li data-v-0d572f78="" class="q-preinstall" @click="getProblem('AI会替代人类工作吗')">AI会替代人类工作吗 →</li>
                              </ul>
                            </div>
                            <div data-v-0d572f78="" class="column">
                              <div data-v-0d572f78="" class="h-item">
                                ...
                                <div data-v-0d572f78="" class="tit">AI 百科</div>
                              </div>
                              <ul>
                                <li data-v-0d572f78="" class="q-preinstall" @click="getProblem('简单解释一下人工智能')">简单介绍一下人工智能 →</li>
                                <li data-v-0d572f78="" class="q-preinstall" @click="getProblem('红烧牛肉的做法')">番茄牛肉的做法 →</li>
                                <li data-v-0d572f78="" class="q-preinstall" @click="getProblem('请介绍一下百度文心')">请介绍一下百度 →</li>
                              </ul>
                            </div>
                          </div>
...
<!--                            <div class="el-textarea">-->
                                <textarea v-model="userInput" @keydown.enter="sendUserInput" autocomplete="off" placeholder="请输入您的问题……" maxlength="3000" class="el-textarea__inner" style="min-height: 46px; height: 46px;" ></textarea>
                                <!---->
<!--                            </div>-->
                            <button type="button" class="el-button btn-send el-button--default" style=""  :disabled="sendButtonDisabled" @click="sendUserInput"  >
                        ...
                        <div data-v-65167152="" class="copyright">
                            <div data-v-65167152=""><a data-v-65167152=""></a>
                            <!----><a data-v-65167152="" href="https://beian.miit.gov.cn/" target="_blank" style="margin-left: 15px;">蜀ICP备2023013300号-1</a></div>
                        </div>
                    </div>
                </div>
            </div>
